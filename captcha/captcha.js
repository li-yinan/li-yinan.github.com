!function(t, r) {
    ...
    , function(t, r, n) {
        ...
        t.exports = function(t) {
            ...
            for (var n = 0, e = r.length; n < e; n++)
                if (new RegExp("/" + r[n] + "\\.(\\S*?\\.min\\.)?js").test(t))
                    return o[r[n]];
            return ""
        }
    }
        ...
        var n = {}.toString
          , e = {
            slice: function(t, r, n) {
                for (var e = [], o = r || 0, i = n || t.length; o < i; o++)
                    e.push(o);
                return e
            },
            ...
            sample: function(t, r) {
                ...
                if (n <= r)
                    return t;
                for (var e = [], o = 0, i = 0; i < n; i++)
                    i >= o * (n - 1) / (r - 1) && (e.push(t[i]),
                    o += 1);
                return e
            },
            ...
            uuid: function a(t, r) {
                ...
                t)
                    for (e = 0; e < t; e++)
                        a[e] = n[0 | Math.random() * r];
                else {
                    var o = void 0;
                    for (a[8] = a[13] = a[18] = a[23] = "-",
                    a[14] = "4",
                    e = 0; e < 36; e++)
                        a[e] || (o = 0 | 16 * Math.random(),
                        a[e] = n[19 === e ? 3 & o | 8 : o])
                }
                return a.join("")
            },
            ...
            encodeUrlParams: function(t) {
                var r = [];
                for (var n in t)
                    t.hasOwnProperty(n) && r.push(window.encodeURIComponent(n) + "=" + window.encodeURIComponent(t[n]));
                return r.join("&")
            }
        };
        t.exports = e
    ...
    , function(t, r, n) {
        ...
        var o, i = n(6), a = n(4), c = n(1), u = c.REQUEST_SCRIPT_ERROR, s = c.REQUEST_API_ERROR, l = c.REQUEST_IMG_ERROR, f = c.BUSINESS_ERROR, p = n(3), h = n(2), d = n(9), y = d.uuid, v = (o = {},
        e(o, s, "api"),
        e(o, l, "image"),
        e(o, u, "script"),
        e(o, f, "business"),
    ...
    , function(t, r) {
        t.exports = function() {
            return 'https://weixin.citicsinfo.com/tztweb/deal/index.html#!/account/login.html';
    ...
    , function(t, r) {
        ...
        function e(t, r, e, a) {
            ...
            r = null),
            a || (a = {});
            var l, f, p = Math.random().toString(36).slice(2, 9), h = a.prefix || "__JSONP", d = a.name || h + ("_" + p) + ("_" + i++), y = a.param || "callback", v = a.timeout || 6e3, m = window.encodeURIComponent, g = document.getElementsByTagName("script")[0] || document.head;
